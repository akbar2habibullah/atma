...
\item Why does NoPE exact retrieval remain zero after likelihood and BABILong recover, and why does RoPE not benefit from the same cap?
\item Does Polar's remaining natural-text retrieval gap improve with longer or mixed-domain training, or reflect a synthetic-to-natural induction bias?
\end{enumerate}
