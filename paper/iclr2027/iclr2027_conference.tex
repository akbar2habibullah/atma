...
Polar also limits mean BPB inflation to $1.26\times$ at 256K, compared with $5.65\times$ for NoPE and $1.75\times$ for RoPE. This stability accompanies a short-context cost: mean accuracy over eight 2K controls is 43.29\% for Polar, 45.15\% for NoPE, and 44.60\% for RoPE. The 1.86-point gap to NoPE (approximately 1.5 points relative to the matched-group mean) prevents a blanket quality claim. Per-task results are in Appendix~\ref{appendix:quality}.
