...
\toprule
 & \multicolumn{4}{c}{\textbf{Needle Accuracy (\%) $\uparrow$}} & \multicolumn{3}{c}{\textbf{Clean Perplexity (nats) $\downarrow$}} \\
\cmidrule(lr){2-5} \cmidrule(lr){6-8}
\textbf{Distance} & \textbf{Polar (no mem)} & \textbf{NoPE+Mem} & \textbf{RoPE+Mem} & \textbf{Ours} & \textbf{NoPE+Mem} & \textbf{RoPE+Mem} & \textbf{Ours} \\
\midrule
2,048 (1$\times$)  & 96\% & 98\% & 74\% & 91\% & 2.66 & 2.81 & 2.70 \\
4,096 (2$\times$)  & 40\% & 98\% & 55\% & 95\% & 2.52 & 2.72 & \textbf{2.45} \\
8,192 (4$\times$)  & 15\% & 94\% & 29\% & 93\% & 2.39 & 2.74 & \textbf{2.22} \\
16,384 (8$\times$) & 8\%  & 85\% & 9\%  & \textbf{98\%} & 2.29 & 2.79 & \textbf{2.09} \\
32,768 (16$\times$)& 3\%  & 48\% & 0\%  & \textbf{96\%} & 2.29 & 2.82 & \textbf{2.01} \\
65,536 (32$\times$)& 0\%  & 16\% & 0\%  & \textbf{93\%} & 2.34 & 2.86 & \textbf{1.96} \\
\bottomrule
\end{tabular}
...
\begin{enumerate}
    ...
    \item \textbf{Polar vs. Baselines Contrast:} While Softmax + Titans memory performs well at shorter context lengths, it collapses to 16\% retrieval at 64K. RoPE + Titans memory collapses even faster, falling to 0\% retrieval by 32K context. This occurs because neither traditional softmax nor RoPE representations are length-invariant, leading to activation drift that corrupts the memory readout.
\end{enumerate}
