...
This is the no-training companion to ablation.train:
    ...
    python -m scaled_ablation.open_baselines --log_dir scaled_ablation/open_logs
...
from scaled_ablation.config_schema import EVAL_LENGTHS
...
def parse_args():
    ...
    ap.add_argument("--log_dir", default="scaled_ablation/open_logs",
